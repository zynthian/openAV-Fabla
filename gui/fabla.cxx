...
// Modified by hand: Fernando Moyano 2024-2025 fernando@zynthian.org
...
void FablaUI::select_page(unsigned int page) {
  ...
  select_pad(selectedPad);
}

void FablaUI::cb_page1(Pad* o, void* v) {
  ((FablaUI*)(o->parent()->user_data()))->select_page(0);
}
void FablaUI::cb_page2(Pad* o, void* v) {
  ((FablaUI*)(o->parent()->user_data()))->select_page(1);
}
void FablaUI::cb_page3(Pad* o, void* v) {
  ((FablaUI*)(o->parent()->user_data()))->select_page(2);
}
void FablaUI::cb_page4(Pad* o, void* v) {
  ((FablaUI*)(o->parent()->user_data()))->select_page(3);
}
...
Fl_Double_Window* FablaUI::setupUI() {
  ...
  { w = new Fl_Double_Window(515, 490, "Fabla");
    ...
    { page1 = new Pad(50, 181, 19, 19, "1");
      page1->box(FL_UP_BOX);
      page1->selected(true);
      page1->loaded(true);
      page1->color(FL_YELLOW);
      page1->selection_color(FL_GREEN);
      page1->labeltype(FL_NORMAL_LABEL);
      page1->labelfont(0);
      page1->labelsize(14);
      page1->labelcolor(FL_YELLOW);
      page1->callback((Fl_Callback*)cb_page1);
      page1->align(Fl_Align(FL_ALIGN_CENTER));
      page1->when(FL_WHEN_RELEASE);
    } // Pad* page1
    { page2 = new Pad(70, 181, 19, 19, "2");
      page2->box(FL_UP_BOX);
      page2->selected(false);
      page2->loaded(true);
      page2->color(FL_YELLOW);
      page2->selection_color(FL_GREEN);
      page2->labeltype(FL_NORMAL_LABEL);
      page2->labelfont(0);
      page2->labelsize(14);
      page2->labelcolor(FL_YELLOW);
      page2->callback((Fl_Callback*)cb_page2);
      page2->align(Fl_Align(FL_ALIGN_CENTER));
      page2->when(FL_WHEN_RELEASE);
    } // Pad* page2
    { page3 = new Pad(90, 181, 19, 19, "3");
      page3->box(FL_UP_BOX);
      page3->selected(false);
      page3->loaded(true);
      page3->color(FL_YELLOW);
      page3->selection_color(FL_GREEN);
      page3->labeltype(FL_NORMAL_LABEL);
      page3->labelfont(0);
      page3->labelsize(14);
      page3->labelcolor(FL_YELLOW);
      page3->callback((Fl_Callback*)cb_page3);
      page3->align(Fl_Align(FL_ALIGN_CENTER));
      page3->when(FL_WHEN_RELEASE);
    } // Pad* page3
    { page4 = new Pad(110, 181, 19, 19, "4");
      page4->box(FL_UP_BOX);
      page4->selected(false);
      page4->loaded(true);
      page4->color(FL_YELLOW);
      page4->selection_color(FL_GREEN);
      page4->labeltype(FL_NORMAL_LABEL);
      page4->labelfont(0);
      page4->labelsize(14);
      page4->labelcolor(FL_YELLOW);
      page4->callback((Fl_Callback*)cb_page4);
      page4->align(Fl_Align(FL_ALIGN_CENTER));
      page4->when(FL_WHEN_RELEASE);
    } // Pad* page4
    ...
    { p13 = new Pad(15, 205, 75, 64, pad_labels[12]);
    ...
    { p14 = new Pad(97, 205, 75, 64, pad_labels[13]);
    ...
    { p15 = new Pad(178, 205, 75, 64, pad_labels[14]);
    ...
    { p16 = new Pad(259, 205, 75, 64, pad_labels[15]);
    ...
    { p9 = new Pad(15, 273, 75, 64, pad_labels[8]);
    ...
    { p5 = new Pad(15, 341, 75, 64, pad_labels[4]);
    ...
    { p1 = new Pad(15, 411, 75, 64, pad_labels[0]);
    ...
    { p10 = new Pad(97, 273, 75, 64, pad_labels[9]);
    ...
    { p6 = new Pad(97, 341, 75, 64, pad_labels[5]);
    ...
    { p2 = new Pad(97, 411, 75, 64, pad_labels[1]);
    ...
    { p11 = new Pad(178, 273, 75, 64, pad_labels[10]);
    ...
    { p7 = new Pad(178, 341, 75, 64, pad_labels[6]);
    ...
    { p3 = new Pad(178, 411, 75, 64, pad_labels[2]);
    ...
    { p12 = new Pad(259, 273, 75, 64, pad_labels[11]);
    ...
    { p8 = new Pad(259, 341, 75, 64, pad_labels[7]);
    ...
    { p4 = new Pad(259, 411, 75, 64, pad_labels[3]);
    ...
    */
    ...
    switch ( fnfc.show() )
    {
      ...
      default:
      {
        ...
        writeLoadSample(fabla, pad, fnfc.filename(), strlen( fnfc.filename() ));
